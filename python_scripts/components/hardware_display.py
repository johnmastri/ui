...
Replicates the Vue.js HardwareDisplay functionality in Kivy.
"""
...
class HardwareDisplayContainer(BoxLayout):
    ...
    def __init__(self, parameter_store, **kwargs):
        ...
        # Mock display
        self.mock_display = HardwareDisplay(parameter_store)
