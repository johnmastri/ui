<template>
  <div class="parameter-knob-container" :class="{ 'dark-theme': theme === 'dark' }">
...
export default {
  ...
  methods: {
    ...
    handleKnobDrag(event) {
      ...
      this.$emit('value-changed', newValue, this.paramId)
    },
...
.parameter-knob-container.dark-theme {
  background: #1a1a1a;
...
.parameter-knob-container.dark-theme .parameter-knob-label {
  color: #00ff00;
...
.parameter-knob-container.dark-theme .parameter-knob {
...
.parameter-knob-container.dark-theme .parameter-knob:hover {
  border-color: #00ffff;
  box-shadow:
    inset 0 2px 4px rgba(0,0,0,0.3),
...
.parameter-knob-container.dark-theme .knob-indicator {
  background: #00ffff;
  box-shadow: 0 1px 3px rgba(0, 255, 255, 0.5);
}
...
.parameter-knob-container.dark-theme .parameter-knob-value {
  color: #ffffff;
  background: #333;
